...
**Confort d'usage** (refonte du 03/08) : recherche et filtres dans les sorties et les randos, bande des jours qui se centre sur le jour choisi avec un repère « aujourd'hui », lecture de la journée au choix **par public** ou en **fil chronologique**, synthèse et **récap copiable** du bilan, **mode nuit automatique** (il suit le réglage du téléphone), deux colonnes sur tablette, et une **feuille d'impression** pour afficher le programme dans le mobil-home ou garder le bilan sur papier. Contrastes vérifiés au niveau AA dans les deux thèmes, cibles tactiles à 44 px partout.
